...
export default function App() {
  useEffect(() => {
    ...
    function updateAboutHighlights() {
      ...
      const triggerPoints = [0.45, 0.60, 0.75, 0.85];
    ...
    <>
        ...
        <div className="product-cards__container">
          ...
          <div className="product-cards__grid">
            ...
            <div className="product-cards__column">
              ...
              {[
                { icon: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2', title: '팀에 합류', desc: '모든 과정을 함께하는 전담 엔지니어' },
            ...
            <div className="product-cards__column">
              ...
              {[
                { title: '웹 + 앱 통합', desc: '한 플랫폼에서 모든 채널 관리' },
                { title: '즉시 수정', desc: '개발자 없이 클릭만으로 반영' },
                { title: '자동 스케줄', desc: '배너 및 콘텐츠 자동 변경' },
                { title: '실시간 분석', desc: '성과를 한눈에 파악' }
              ].map((item, i) => (
                <div className="product-cards__item" key={i}>
                  <div className="product-cards__item-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
            ...
            <div className="product-cards__column">
              ...
              {[
                { title: '칸반 보드', desc: '프로젝트 진행 상황 실시간 확인' },
                { title: '출퇴근 관리', desc: '팀원 근태 현황을 한눈에 확인' },
                { title: '휴가 관리', desc: '신청부터 승인까지 자동화' },
                { title: '지출 관리', desc: '팀 비용을 투명하게 관리' }
              ].map((item, i) => (
                <div className="product-cards__item" key={i}>
                  <div className="product-cards__item-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <div className="contact-modal" id="contactModal">
        <div className="contact-modal__container">
          <button className="contact-modal__close" aria-label="Close Modal">&times;</button>
          ...
          <div className="contact-modal__content">
            ...
            <form className="contact-modal__form">
              ...
              <button type="submit" className="contact-modal__submit">문의하기</button>
            </form>
          </div>
        </div>
      </div>
